...
class PaymentClientTest {
	...
	void shouldReturnApprovedStatusWhenProcessPayment_success() {
		...
		when(paymentClient.processPayment(any(String.class), any(PaymentRequest.class))).thenReturn(mockResponse);
	...
	void shouldThrowExceptionWhenProcessPaymentFails() {
		when(paymentClient.processPayment(any(String.class), any(PaymentRequest.class)))
